...
export function Form() {
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-b from-green-50 to-white py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <motion.div
          ...
          className="absolute -top-20 -left-20 w-96 h-96 bg-green-400 rounded-full filter blur-3xl"
        />
        ...
        >
          <div className="w-[500px] h-[500px] rotate-45 bg-gradient-to-r from-green-300 to-purple-300 rounded-full filter blur-3xl" />
        </motion.div>
      ...
      >
        ...
        <motion.div className="mb-12 text-center" variants={titleVariants}>
          ...
          <motion.div
            className="mt-6 w-24 h-1 bg-gradient-to-r from-green-500 to-green-700 mx-auto rounded-full"
            initial={{ scaleX: 0 }}
            animate={{ scaleX: 1 }}
        ...
        >
          <motion.button
            type="submit"
            className="px-8 py-3 bg-gradient-to-r from-green-500 to-green-600 text-white rounded-lg shadow-lg hover:from-green-600 hover:to-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 transition-all duration-200"
