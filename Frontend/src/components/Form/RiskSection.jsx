    ...
    <div className="space-y-8">
      ...
      <div>
        ...
        <div className="space-y-6">
          ...
          <motion.div 
            className="bg-gradient-to-br from-green-50 to-green-100 p-6 rounded-xl shadow-md border border-black-100"
            whileHover="hover"
            variants={cardVariants}
          >
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    onChange={handleChange}
                    className="w-full px-4 py-3 text-base border rounded-lg shadow-sm focus:ring-2 focus:ring-green-500 focus:border-green-500 border-gray-300"
                    step="0.01"
                    placeholder="Enter percentage"
                  />
                  <span className="absolute right-11 top-1/2 -translate-y-1/2 text-sm text-gray-500">% Profit</span>
