      ...
      <div className="container mx-auto px-4 py-16 relative">
          ...
          <div className="p-8 lg:p-12">
            ...
            >
                ...
                <div className="relative group">
                  ...
                  <motion.input
                    ...
                    className="appearance-none block w-full pl-10 pr-3 py-2.5 border border-gray-300 rounded-lg 
                             ...
                             hover:border-green-400 bg-gray-50 hover:bg-white"
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className="w-full flex justify-center items-center py-3 px-4 bg-green-600 text-white rounded-lg 
        ...
        <motion.div variants={itemVariants} className="text-center mt-8">
          ...
          <Link to="/sign-up">
            <motion.span
              whileHover={{ scale: 1.05 }}
              className="font-medium text-green-600 hover:text-green-500 inline-block cursor-pointer"
            >
              Sign up
            </motion.span>
          </Link>
