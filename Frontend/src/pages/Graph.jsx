          ...
          <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <button
                ...
                className="p-4 bg-green-50 rounded-lg border border-green-100 hover:bg-green-100 transition-colors duration-200 text-left"
              >
                <h4 className="font-medium text-green-700 mb-1">PDF Report</h4>
