...
export function Home() {
  ...
  return (
    <>
      <Navbar />
      <div className="min-h-scree bg-gradient-to-b from-gray-50 via-white to-gray-50">
        {/* Hero Section */}
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              >
                <motion.div
                  ...
                  className="absolute -top-20 -left-20 w-40 h-40 bg-green-50 rounded-full filter blur-3xl"
                />
                <motion.h1
                ...
                <motion.div variants={itemVariants} className="flex gap-4">
                  <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="px-8 py-4 bg-green-600 text-white rounded-xl font-medium flex items-center gap-2 hover:bg-green-700 transition-colors"
                  >
                    Start Building
              ...
              >
                <motion.div
                  ...
                  animate={{ opacity: 1, scale: 1 }}
                  transition={{ duration: 0.8 }}
                  className="absolute -top-20 -right-20 w-60 h-60 bg-green-50 rounded-full filter blur-3xl"
                />
                <img
                  src={tradingImage}
        ...
        <motion.section
          ...
          className="py-16 bg-gradient-to-r from-green-50 via-white to-green-50"
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <motion.div
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <motion.div
                ...
                className="relative"
              >
                <div className="absolute inset-0 bg-gradient-to-r from-green-500 to-purple-500 rounded-xl opacity-10 blur-2xl" />
                <img
                  src={tradingImage2}
        ...
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="px-8 py-4 bg-white text-green-600 rounded-xl font-medium shadow-lg hover:shadow-xl transition-all"
            >
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between mb-4">
        <div className="p-3 bg-green-50 rounded-xl text-green-600">{icon}</div>
        <motion.div
          initial={{ scale: 0 }}
          whileInView={{ scale: 1 }}
          viewport={{ once: true }}
    ...
    >
      ...
      <div className="mt-4 pt-4 border-t border-gray-100">
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.98 }}
          className="w-full py-2 px-4 bg-green-50 text-green-600 rounded-lg hover:bg-green-100 transition-colors text-sm font-medium"
        >
          View Details
        </motion.button>
      </div>
  ...
  return (
    ...
    >
      ...
      <Link to={linkTo}>
        <motion.span
          whileHover={{ x: 5 }}
          className="text-green-600 hover:text-green-700 text-sm font-medium inline-flex items-center gap-1 cursor-pointer"
        >
          {link}
        </motion.span>
      </Link>
...
function FeatureCard({ icon, title, description, benefits, color }) {
  ...
  return (
    ...
    >
      <div className="absolute inset-0 bg-gradient-to-r from-green-500/10 to-purple-500/10 rounded-2xl blur-xl transition-all duration-300 group-hover:scale-110" />
